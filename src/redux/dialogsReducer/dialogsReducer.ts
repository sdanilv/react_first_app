...
const LOAD_ALL_CHAT_MESSAGE = "myApp/dialogs/LOAD_ALL_CHAT_MESSAGE";
 ...
 type MessageType = { message: string, userId: string }
...
type ActionType = Action<typeof ADD_CHAT_MESSAGE, { message: string, id: string, userId: string }> |
...
export const AddMessageToChat = (id:string, message: string, myId: string):ActionType => ({
