...
const SUBSCRIBE_USER = "myApp/users/SUBSCRIBE-USER";
const UNSUBSCRIBE_USER = "myApp/users/UNSUBSCRIBE-USER";
const SET_USERS = "myApp/users/SET-USER";
const CHANGE_PAGE = "myApp/users/CHANGE_PAGE";
const CHANGE_ALL_USERS_COUNT = "myApp/users/CHANGE_ALL_USERS_COUNT";
const CHANGE_PAGE_USERS_COUNT = "myApp/users/CHANGE_PAGE_USERS_COUNT";
const ADD_IN_BLOCK_BUTTONS = "myApp/users/ADD_IN_BLOCK_BUTTONS";
const REMOVE_FROM_BLOCK_BUTTONS = "myApp/users/REMOVE_IN_BLOCK_BUTTONS";
const SET_TOGGLE_LOADER = "myApp/users/SET_TOGGLE_LOADER";
const SET_KIT = "myApp/users/SET_KIT";
